...
final readonly class RouteInvoker
{
     ...
     *
     * @param array{path: string, methods: list<string>, controller: string, env: string|null, requirements: array<string, string>, priority?: int, defaults?: array<string, mixed>, schemes?: list<string>, host?: string|null, description?: string|null} $route
     * @param array<string, mixed>                                                                                                                                                                                                                          $input
     * @param list<string>                                                                                                                                                                                                                                  $placeholders
