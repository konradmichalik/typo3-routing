...
<header class="container">
    ...
    <p><code><?php echo htmlspecialchars($siteHostname); ?></code><?php if ('' !== $gitBranch) { ?> &middot; branch <code><?php echo htmlspecialchars($gitBranch); ?></code><?php } ?><?php if ('' !== $gitCommit) { ?> &middot; commit <code><?php echo htmlspecialchars($gitCommit); ?></code><?php } ?></p>
    <?php } ?>
</header>
