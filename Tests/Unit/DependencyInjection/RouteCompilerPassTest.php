...
final class RouteCompilerPassTest extends TestCase
{
    ...
    #[Test]
    public function throwsWhenAPathUsesInlinePlaceholderSyntax(): void
    {
        $this->expectException(LogicException::class);
        $this->expectExceptionCode(1750000039);

        $this->discover($this->buildContainer(['inline' => InlinePlaceholderController::class]));
    }

    #[Test]
    public function throwsWhenALegacyPathUsesInlinePlaceholderSyntax(): void
    {
        $this->expectException(LogicException::class);
        $this->expectExceptionCode(1750000039);

        $this->discover($this->buildContainer(['legacy_inline' => InlinePlaceholderLegacyPathController::class]));
    }
