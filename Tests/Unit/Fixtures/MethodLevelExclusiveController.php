...
/**
 * MethodLevelExclusiveController.
 *
 * @author Konrad Michalik <hej@konradmichalik.dev>
 */
final class MethodLevelExclusiveController implements RouteControllerInterface
{
    #[Route(path: '/api/method-exclusive', exclusive: true)]
