...
/**
 * InvalidCorsCredentialsController.
 *
 * @author Konrad Michalik <hej@konradmichalik.dev>
 */
final class InvalidCorsCredentialsController implements RouteControllerInterface
{
    #[Route(path: '/api/cors/invalid', name: 'cors_invalid')]
